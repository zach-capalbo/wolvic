...
public class TextInputImpl implements ITextInput {
    SessionImpl mSession;
    ISession.TextInputDelegate mDelegate;
    ...
    @Override
    public void setDelegate(@Nullable ISession.TextInputDelegate delegate) {
    ...
    @NonNull
    @Override
    public ISession.TextInputDelegate getDelegate() {
        return mDelegate;
    }
