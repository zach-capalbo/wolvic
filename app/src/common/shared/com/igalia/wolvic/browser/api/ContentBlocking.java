...
public class ContentBlocking {
    ...
    public static class Settings {
        ...
        public static class Builder {
             ...
             *            {@link com.igalia.wolvic.browser.api.ContentBlocking.AntiTracking} flags.
             * @return This Builder instance.
             */
            public @NonNull
            com.igalia.wolvic.browser.api.ContentBlocking.Settings.Builder antiTracking(final @CBAntiTracking int cat) {
             ...
             *
             * @param cat The categories of resources that should be blocked. Use one or more of the
             *            {@link com.igalia.wolvic.browser.api.ContentBlocking.SafeBrowsing} flags.
             * @return This Builder instance.
             */
            public @NonNull
            com.igalia.wolvic.browser.api.ContentBlocking.Settings.Builder safeBrowsing(final @CBSafeBrowsing int cat) {
             ...
             *                 com.igalia.wolvic.browser.api.ContentBlocking.CookieBehavior} flags.
             * @return The Builder instance.
             */
            public @NonNull
            com.igalia.wolvic.browser.api.ContentBlocking.Settings.Builder cookieBehavior(final @CBCookieBehavior int behavior) {
             ...
             */
            public @NonNull
            com.igalia.wolvic.browser.api.ContentBlocking.Settings.Builder cookieBehaviorPrivateMode(final @CBCookieBehavior int behavior) {
             ...
             *
             * @param lifetime The enforced cookie lifetime. Use one of the {@link com.igalia.wolvic.browser.api.ContentBlocking.CookieLifetime} flags.
             * @return The Builder instance.
             */
            public @NonNull
            com.igalia.wolvic.browser.api.ContentBlocking.Settings.Builder cookieLifetime(final @CBCookieLifetime int lifetime) {
             ...
             *              to {@link com.igalia.wolvic.browser.api.ContentBlocking.CookieBehavior#ACCEPT_NON_TRACKERS} or {@link
             *              com.igalia.wolvic.browser.api.ContentBlocking.CookieBehavior#ACCEPT_FIRST_PARTY_AND_ISOLATE_OTHERS}.
             * @return The Builder instance.
             */
            public @NonNull
            com.igalia.wolvic.browser.api.ContentBlocking.Settings.Builder enhancedTrackingProtectionLevel(final @CBEtpLevel int level) {
             ...
             */
            public @NonNull
            com.igalia.wolvic.browser.api.ContentBlocking.Settings.Builder strictSocialTrackingProtection(final boolean enabled) {
             ...
             * is set to either {@link com.igalia.wolvic.browser.api.ContentBlocking.CookieBehavior#ACCEPT_NON_TRACKERS} or {@link
             * com.igalia.wolvic.browser.api.ContentBlocking.CookieBehavior#ACCEPT_FIRST_PARTY_AND_ISOLATE_OTHERS}.
             *
             ...
             */
            public @NonNull
            com.igalia.wolvic.browser.api.ContentBlocking.Settings.Builder cookiePurging(final boolean enabled) {
    ...
    @IntDef(
            flag = true,
            value = {
                    com.igalia.wolvic.browser.api.ContentBlocking.AntiTracking.AD,
                    com.igalia.wolvic.browser.api.ContentBlocking.AntiTracking.ANALYTIC,
                    com.igalia.wolvic.browser.api.ContentBlocking.AntiTracking.SOCIAL,
                    com.igalia.wolvic.browser.api.ContentBlocking.AntiTracking.CONTENT,
                    com.igalia.wolvic.browser.api.ContentBlocking.AntiTracking.TEST,
                    com.igalia.wolvic.browser.api.ContentBlocking.AntiTracking.CRYPTOMINING,
                    com.igalia.wolvic.browser.api.ContentBlocking.AntiTracking.FINGERPRINTING,
                    com.igalia.wolvic.browser.api.ContentBlocking.AntiTracking.DEFAULT,
                    com.igalia.wolvic.browser.api.ContentBlocking.AntiTracking.STRICT,
                    com.igalia.wolvic.browser.api.ContentBlocking.AntiTracking.STP,
                    com.igalia.wolvic.browser.api.ContentBlocking.AntiTracking.NONE
            })
    ...
    @IntDef(
            flag = true,
            value = {
                    com.igalia.wolvic.browser.api.ContentBlocking.SafeBrowsing.MALWARE, com.igalia.wolvic.browser.api.ContentBlocking.SafeBrowsing.UNWANTED,
                    com.igalia.wolvic.browser.api.ContentBlocking.SafeBrowsing.HARMFUL, com.igalia.wolvic.browser.api.ContentBlocking.SafeBrowsing.PHISHING,
                    com.igalia.wolvic.browser.api.ContentBlocking.SafeBrowsing.DEFAULT, com.igalia.wolvic.browser.api.ContentBlocking.SafeBrowsing.NONE
            })
    ...
    @Retention(RetentionPolicy.SOURCE)
    @IntDef({
            com.igalia.wolvic.browser.api.ContentBlocking.CookieBehavior.ACCEPT_ALL, com.igalia.wolvic.browser.api.ContentBlocking.CookieBehavior.ACCEPT_FIRST_PARTY,
            com.igalia.wolvic.browser.api.ContentBlocking.CookieBehavior.ACCEPT_NONE, com.igalia.wolvic.browser.api.ContentBlocking.CookieBehavior.ACCEPT_VISITED,
            com.igalia.wolvic.browser.api.ContentBlocking.CookieBehavior.ACCEPT_NON_TRACKERS
    })
    ...
    @Retention(RetentionPolicy.SOURCE)
    @IntDef({com.igalia.wolvic.browser.api.ContentBlocking.CookieLifetime.NORMAL, com.igalia.wolvic.browser.api.ContentBlocking.CookieLifetime.RUNTIME, com.igalia.wolvic.browser.api.ContentBlocking.CookieLifetime.DAYS})
            public @interface CBCookieLifetime {}

    @Retention(RetentionPolicy.SOURCE)
    @IntDef({com.igalia.wolvic.browser.api.ContentBlocking.EtpLevel.NONE, com.igalia.wolvic.browser.api.ContentBlocking.EtpLevel.DEFAULT, com.igalia.wolvic.browser.api.ContentBlocking.EtpLevel.STRICT})
    ...
    public static class BlockEvent {
         ...
         *
         * @return One or more of the {@link com.igalia.wolvic.browser.api.ContentBlocking.AntiTracking} flags.
         */
        @UiThread
         ...
         *
         * @return One or more of the {@link com.igalia.wolvic.browser.api.ContentBlocking.SafeBrowsing} flags.
         */
        @UiThread
         ...
         *
         * @return One or more of the {@link com.igalia.wolvic.browser.api.ContentBlocking.CookieBehavior} flags.
         */
        @UiThread
    ...
    public interface Delegate {
         ...
         * RuntimeSettings} and enable content blocking via {@link ISessionSettings}.
         *
         * @param session The GeckoSession that initiated the callback.
         * @param event The {@link com.igalia.wolvic.browser.api.ContentBlocking.BlockEvent} details.
         */
        @UiThread
        default void onContentBlocked(
                @NonNull final ISession session, @NonNull final com.igalia.wolvic.browser.api.ContentBlocking.BlockEvent event) {}
