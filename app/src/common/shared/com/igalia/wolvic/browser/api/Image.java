...
public interface Image {
     ...
     * @return A {@link IResult} that resolves to the bitmap when ready. Will resolve
     *     exceptionally to {@link org.mozilla.geckoview.Image.ImageProcessingException} if the image cannot be processed.
     */
    @NonNull
    IResult<Bitmap> getBitmap(final int size);
}