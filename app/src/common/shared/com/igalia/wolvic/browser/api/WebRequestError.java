 ...
 * ISession.NavigationDelegate#onLoadError(ISession, String, com.igalia.wolvic.browser.api.WebRequestError)}.
 */
@AnyThread
public interface WebRequestError {
     ...
     *
     * <p>See also {@link ISession.NavigationDelegate#onLoadError}
     */
