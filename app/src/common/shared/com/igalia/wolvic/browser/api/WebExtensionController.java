...
public interface WebExtensionController {
    /**
    ...
    interface PromptDelegate {
         ...
         *                  prompt dialog.
         * @return A {@link IResult} that completes to either {@link com.igalia.wolvic.browser.api.AllowOrDeny#ALLOW ALLOW} if
         * this extension should be installed or {@link com.igalia.wolvic.browser.api.AllowOrDeny#DENY DENY} if this extension
         * should not be installed. A null value will be interpreted as {@link com.igalia.wolvic.browser.api.AllowOrDeny#DENY
         * DENY}.
         */
        @Nullable
        default IResult<com.igalia.wolvic.browser.api.AllowOrDeny> onInstallPrompt(final @NonNull WebExtension extension) {
            return null;
        }
         ...
         * @return A {@link IResult} that completes to either {@link com.igalia.wolvic.browser.api.AllowOrDeny#ALLOW ALLOW} if
         * this extension should be update or {@link com.igalia.wolvic.browser.api.AllowOrDeny#DENY DENY} if this extension should
         * not be update. A null value will be interpreted as {@link com.igalia.wolvic.browser.api.AllowOrDeny#DENY DENY}.
         */
        @Nullable
        default IResult<com.igalia.wolvic.browser.api.AllowOrDeny> onUpdatePrompt(
    ...
    interface DebuggerDelegate {
         ...
         * objects, e.g. using {@link org.mozilla.geckoview.WebExtension#setActionDelegate} and {@link
     ...
     * @see WebExtensionController.PromptDelegate
     */
    @UiThread
    @Nullable
    WebExtensionController.PromptDelegate getPromptDelegate();
    /**
     * Set the {@link com.igalia.wolvic.browser.api.WebExtensionController.PromptDelegate} for this instance. This delegate will be used to be notified
     * whenever an extension is being installed or needs new permissions.
     *
     * @param delegate the delegate instance.
     * @see com.igalia.wolvic.browser.api.WebExtensionController.PromptDelegate
     */
    @UiThread
    void setPromptDelegate(final @Nullable PromptDelegate delegate);

    /**
     * Set the {@link WebExtensionController.DebuggerDelegate} for this instance. This delegate will receive updates about
     ...
     * com.igalia.wolvic.browser.api.WebExtensionController.PromptDelegate#installPrompt}, you can use this method to prompt the user if appropriate.
     *
     ...
     * @return A {@link IResult} that will complete when the installation process finishes. For
     ...
     * @see com.igalia.wolvic.browser.api.WebExtensionController.PromptDelegate#installPrompt
     * @see WebExtension.InstallException.ErrorCodes
     * @see WebExtension#metaData
     */
    @NonNull
    @AnyThread
    IResult<WebExtension> install(final @NonNull String uri);
    ...
    @NonNull
    @AnyThread
    IResult<WebExtension> setAllowedInPrivateBrowsing(final @NonNull WebExtension extension, final boolean allowed);
     ...
     * @return A {@link IResult} that completes with the extension once it's installed.
     */
    @NonNull
    @AnyThread
    IResult<WebExtension> installBuiltIn(final @NonNull String uri);
    ...
    @NonNull
    @AnyThread
    IResult<WebExtension> ensureBuiltIn(final @NonNull String uri, final @Nullable String id);
     ...
     * @return A {@link IResult} that will complete when the uninstall process is completed.
     */
    @NonNull
    @AnyThread
    IResult<Void> uninstall(final @NonNull WebExtension extension);


    @Retention(RetentionPolicy.SOURCE)
    @IntDef({com.igalia.wolvic.browser.api.WebExtensionController.EnableSource.USER, com.igalia.wolvic.browser.api.WebExtensionController.EnableSource.APP})
     ...
     *     the user,use {@link com.igalia.wolvic.browser.api.WebExtensionController.EnableSource#USER}.
     * @return the new {@link WebExtension} instance, updated to reflect the enablement.
     */
    @AnyThread
    @NonNull
    IResult<WebExtension> enable(final @NonNull WebExtension extension, final @EnableSources int source);
    ...
    @AnyThread
    @NonNull
    IResult<WebExtension> disable(final @NonNull WebExtension extension, final @EnableSources int source);
     ...
     *
     * @return a {@link IResult} that will resolve when the list of extensions is available.
     */
    @AnyThread
    @NonNull
    IResult<List<WebExtension>> list();
     ...
     * permissions the {@link com.igalia.wolvic.browser.api.WebExtensionController.PromptDelegate#updatePrompt} will be triggered.
     *
     ...
     * @return A {@link IResult} that will complete when the update process finishes. If an update
     ...
     *     requires new permissions, the {@link com.igalia.wolvic.browser.api.WebExtensionController.PromptDelegate#installPrompt} will be called.
     * @see com.igalia.wolvic.browser.api.WebExtensionController.PromptDelegate#updatePrompt
     */
    @AnyThread
    @NonNull
    IResult<WebExtension> update(final @NonNull WebExtension extension);


    /**
     * Notifies extensions about a active tab change over the `tabs.onActivated` event.
     *
     * @param session The {@link ISession} of the newly selected session/tab.
     * @param active true if the tab became active, false if the tab became inactive.
     */
    @AnyThread
    void setTabActive(@NonNull final ISession session, final boolean active);
