...
public interface IDisplay {
     ...
     * IDisplay} is currently using.
     *
     * <p>If the {@link ISession#isCompositorReady} is false the {@link IResult} will complete
     * with an {@link IllegalStateException}.
     *
     * <p>This function must be called on the UI thread.
     *
     * @return A {@link IResult} that completes with a {@link Bitmap} containing the pixels and
     *     size information of the currently visible rendered web page.
     */
    @UiThread
    @NonNull IResult<Bitmap> capturePixels();
     ...
     */
    @UiThread
    @NonNull IResult<Bitmap> capturePixelsWithAspectPreservingSize(final int width);
