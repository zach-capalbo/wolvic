...
public class RuntimeSettings {
    ...
    public static final class Builder {
        ...
        private RuntimeSettings mSettings = new RuntimeSettings();

        private RuntimeSettings getSettings() {
            return mSettings;
        }
         ...
         */
        public @NonNull
        RuntimeSettings.Builder arguments(final @NonNull String[] args) {
            if (args == null) {
         ...
         */
        public @NonNull
        RuntimeSettings.Builder extras(final @NonNull Bundle extras) {
            if (extras == null) {
         ...
         */
        public @NonNull
        RuntimeSettings.Builder configFilePath(final @Nullable String configFilePath) {
         ...
         */
        public @NonNull
        RuntimeSettings.Builder javaScriptEnabled(final boolean flag) {
         ...
         */
        public @NonNull
        RuntimeSettings.Builder remoteDebuggingEnabled(final boolean enabled) {
         ...
         */
        public @NonNull
        RuntimeSettings.Builder webFontsEnabled(final boolean flag) {
         ...
         */
        public @NonNull
        RuntimeSettings.Builder pauseForDebugger(final boolean enabled) {
         ...
         */
        public @NonNull
        RuntimeSettings.Builder useMaxScreenDepth(final boolean enable) {
         ...
         */
        public @NonNull
        RuntimeSettings.Builder webManifest(final boolean enabled) {
         ...
         */
        public @NonNull
        RuntimeSettings.Builder consoleOutput(final boolean enabled) {
         ...
         *
         * <p>This setting cannot be modified if {@link RuntimeSettings.Builder#automaticFontSizeAdjustment automatic
         ...
         *     disables both this feature and {@link RuntimeSettings.Builder#fontInflation font inflation}.
         * @return The builder instance.
         */
        public @NonNull
        RuntimeSettings.Builder fontSizeFactor(final float fontSizeFactor) {
         ...
         */
        public @NonNull
        RuntimeSettings.Builder enterpriseRootsEnabled(final boolean enabled) {
         ...
         * ISessionSettings#VIEWPORT_MODE_MOBILE}. To improve readability, the font inflation logic
         * will attempt to increase font sizes for the main text content of the page only.
         *
         * <p>The magnitude of font inflation applied depends on the {@link RuntimeSettings.Builder#fontSizeFactor font
         ...
         */
        public @NonNull
        RuntimeSettings.Builder fontInflation(final boolean enabled) {
         ...
         */
        public @NonNull
        RuntimeSettings.Builder displayDensityOverride(final float density) {
         ...
         */
        public @NonNull
        RuntimeSettings.Builder displayDpiOverride(final int dpi) {
         ...
         */
        public @NonNull
        RuntimeSettings.Builder screenSizeOverride(final int width, final int height) {
         ...
         */
        public @NonNull
        RuntimeSettings.Builder loginAutofillEnabled(final boolean enabled) {
         ...
         * android.content.Intent} with action {@link IRuntime#ACTION_CRASHED} when a crash is
         * encountered. Crash details can be found in the Intent extras, such as {@link
         * IRuntime#EXTRA_MINIDUMP_PATH}. <br>
         * <br>
         * The crash handler Service must be declared to run in a different process from the {@link
         * IRuntime}. Additionally, the handler will be run as a foreground service, so the normal
         ...
         * @see IRuntime#ACTION_CRASHED
         */
        public @NonNull
        RuntimeSettings.Builder crashHandler(final @Nullable Class<? extends Service> handler) {
         ...
         */
        public @NonNull
        RuntimeSettings.Builder locales(final @Nullable String[] requestedLocales) {
        ...
        public @NonNull
        RuntimeSettings.Builder contentBlocking(final @NonNull ContentBlocking.Settings cb) {
         ...
         *     RuntimeSettings#COLOR_SCHEME_LIGHT COLOR_SCHEME_*} constants.
         * @return This Builder instance.
         */
        public @NonNull
        RuntimeSettings.Builder preferredColorScheme(final @ColorScheme int scheme) {
         ...
         */
        public @NonNull
        RuntimeSettings.Builder inputAutoZoomEnabled(final boolean flag) {
         ...
         */
        public @NonNull
        RuntimeSettings.Builder doubleTapZoomingEnabled(final boolean flag) {
         ...
         */
        public @NonNull
        RuntimeSettings.Builder glMsaaLevel(final int level) {
         ...
         */
        public @NonNull
        RuntimeSettings.Builder debugLogging(final boolean enable) {
         ...
         */
        public @NonNull
        RuntimeSettings.Builder aboutConfigEnabled(final boolean flag) {
         ...
         */
        public @NonNull
        RuntimeSettings.Builder forceUserScalableEnabled(final boolean flag) {
         ...
         *
         * @param level One of the {@link RuntimeSettings#ALLOW_ALL HttpsOnlyMode} constants.
         * @return This Builder instance.
         */
        public @NonNull
        RuntimeSettings.Builder allowInsecureConnections(final @HttpsOnlyMode int level) {
