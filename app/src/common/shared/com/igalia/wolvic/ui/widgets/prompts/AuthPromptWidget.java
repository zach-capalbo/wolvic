...
public class AuthPromptWidget extends PromptWidget {
    ...
    public void setAuthOptions(ISession.PromptDelegate.AuthPrompt.AuthOptions aOptions) {
        ...
        if ((aOptions.flags & ISession.PromptDelegate.AuthPrompt.AuthOptions.Flags.ONLY_PASSWORD) != 0) {
