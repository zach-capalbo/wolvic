...
import com.igalia.wolvic.browser.api.ISession.PromptDelegate.ChoicePrompt.Choice;
...
public class ChoicePromptWidget extends PromptWidget {
    ...
    public void setChoices(ISession.PromptDelegate.ChoicePrompt.Choice[] choices) {
    ...
    public void setMenuType(int type) {
        switch (type) {
            case ISession.PromptDelegate.ChoicePrompt.Type.SINGLE:
            case ISession.PromptDelegate.ChoicePrompt.Type.MENU: {
                mList.setChoiceMode(ListView.CHOICE_MODE_SINGLE);
                mCloseButton.setVisibility(View.VISIBLE);
                mOkButton.setVisibility(View.GONE);
            }
            break;
            case ISession.PromptDelegate.ChoicePrompt.Type.MULTIPLE: {
