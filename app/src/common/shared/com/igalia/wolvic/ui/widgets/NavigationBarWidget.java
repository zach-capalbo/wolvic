...
public class NavigationBarWidget extends UIWidget implements ISession.NavigationDelegate,
        ISession.ContentDelegate, WidgetManagerDelegate.WorldClickListener,
    ...
    private void updateUI() {
        ...
        mBinding.navigationBarNavigation.reloadButton.setOnClickListener(v -> {
            ...
            if (mViewModel.getIsLoading().getValue().get()) {
                ...
                int flags = SettingsStore.getInstance(mAppContext).isBypassCacheOnReloadEnabled() ? ISession.LOAD_FLAGS_BYPASS_CACHE : ISession.LOAD_FLAGS_NONE;
    ...
    public void onLocationChange(@NonNull ISession session, @Nullable String url) {
        if (getSession() != null && getSession().getISession() == session) {
    ...
    private void showMenu() {
        ...
        mHamburgerMenu.setMenuDelegate(new HamburgerMenuWidget.MenuDelegate() {
            ...
            public void onSwitchMode() {
                ...
                if (uaMode == ISessionSettings.USER_AGENT_MODE_DESKTOP) {
                    ...
                    mHamburgerMenu.setUAMode(ISessionSettings.USER_AGENT_MODE_DESKTOP);
                    mAttachedWindow.getSession().setUaMode(ISessionSettings.USER_AGENT_MODE_DESKTOP);
                }
