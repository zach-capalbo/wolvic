...
public class PermissionWidget extends PromptDialogWidget {
    ...
    private ISession.PermissionDelegate.Callback mPermissionCallback;
    private String mUri;
    ...
    public void showPrompt(String aUri, PermissionType aType, ISession.PermissionDelegate.Callback aCallback) {
        int titleId;
        int messageId;
        int iconId;
        switch (aType) {
