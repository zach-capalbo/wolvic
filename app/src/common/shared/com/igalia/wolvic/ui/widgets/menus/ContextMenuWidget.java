...
public class ContextMenuWidget extends MenuWidget {
    ...
    public void setContextElement(ISession.ContentDelegate.ContextElement aContextElement) {
        ...
        if (URLUtil.isNetworkUrl(aContextElement.srcUri) && aContextElement.type != ISession.ContentDelegate.ContextElement.TYPE_NONE) {
            ...
            if (aContextElement.type == ISession.ContentDelegate.ContextElement.TYPE_VIDEO) {
            ...
            } else if(aContextElement.type == ISession.ContentDelegate.ContextElement.TYPE_AUDIO) {
