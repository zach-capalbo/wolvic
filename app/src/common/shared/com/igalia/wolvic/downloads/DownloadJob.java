...
public class DownloadJob {
    ...
    public static DownloadJob fromSrc(@NonNull ISession.ContentDelegate.ContextElement contextElement) {
        DownloadJob job = new DownloadJob();
        job.mUri = contextElement.srcUri;
        switch (contextElement.type) {
            case ISession.ContentDelegate.ContextElement.TYPE_NONE:
                job.mContentType = "";
                break;
            case ISession.ContentDelegate.ContextElement.TYPE_AUDIO:
                job.mContentType = "audio";
                break;
            case ISession.ContentDelegate.ContextElement.TYPE_IMAGE:
                job.mContentType = "image";
                break;
            case ISession.ContentDelegate.ContextElement.TYPE_VIDEO:
    ...
    public static DownloadJob fromLink(@NonNull ISession.ContentDelegate.ContextElement contextElement) {
        DownloadJob job = new DownloadJob();
